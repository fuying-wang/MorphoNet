...
@dataclass
class SPANTHERConfig(PretrainedConfig):
    in_dim: int = 768
    n_classes: int = 2
    heads: int = 1
    em_iter: int = 3
...
@dataclass
class DeepAttnMISLConfig(PretrainedConfig):
    cluster_num: 10
    n_classes: 2
...
@dataclass
class LongMILConfig(PretrainedConfig):
    in_dim: int = 1024
    n_classes: int = 2
...
class LongMILConfig(PretrainedConfig):
    ...
    hidden_dim: int = 512
    n_classes: int = 2
    alibi_positon_embedding_path: str = "/home/fywang/Documents/SPANTHER/src/mil_models/LongMIL/alibi_tensor_core.pt"