...
# CUDA_VISIBLE_DEVICES=4 python create_slide_level_prototypes.py \
# --data_source /data1/r20user2/wsi_data/TCGA_NSCLC/extracted_mag20x_patch256/uni_pt_patch_features/h5_files \
# --dataset_csv /home/fywang/Documents/SPANTHER/src/dataset_csv/NSCLC/classification.csv \
# --cluster_method faiss
...
# --dataset_csv /home/fywang/Documents/SPANTHER/src/dataset_csv/CPTAC_KIRC/survival.csv \
# --cluster_method spatialleiden