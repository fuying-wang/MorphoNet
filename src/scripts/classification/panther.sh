...
# lin_emb_model='IndivMLPEmb_SharedIndivPost' # 'LinearEmb'; 'IndivMLPEmb_Shared', 'IndivMLPEmb_Indiv', 'IndivMLPEmb_SharedPost', 'IndivMLPEmb_IndivPost', 'IndivMLPEmb_SharedIndiv' or 'IndivMLPEmb_SharedIndivPost'
max_epoch=20
lr=0.0001
wd=0.00001
lr_scheduler='cosine'
...
echo "all_feat_dirs: ${all_feat_dirs}"
...
# if [[ $load_proto -eq 1 ]]; then
#   cmd="$cmd --load_proto \\
#   --proto_path "splits/${split_dir}/prototypes/prototypes_c${out_size}_${feat_name}_superpatch_connected_faiss_num_${proto_num_samples}.pkl" \\
#   "
# fi

# if [[ $load_proto -eq 1 ]]; then
#   cmd="$cmd --load_proto \\
#   --proto_path "splits/${split_dir}/prototypes/prototypes_${feat_name}_nproto_${out_size}_embed_dim1024.pkl" \\
#   "
# fi
