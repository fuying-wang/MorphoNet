...
# prototypes_uni_pt_patch_features_nproto_16_embed_dim8192

# if [[ $load_proto -eq 1 ]]; then
#   cmd="$cmd --load_proto \\
#   --proto_path "splits/${split_dir}/prototypes/prototypes_${feat_name}_nproto_${out_size}_embed_dim${input_dim}.pkl" \\
#   "
# fi
