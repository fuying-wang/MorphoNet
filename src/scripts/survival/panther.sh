...
# lin_emb_model='IndivMLPEmb_IndivPost' # 'LinearEmb'; 'IndivMLPEmb_Shared', 'IndivMLPEmb_Indiv', 'IndivMLPEmb_SharedPost', 'IndivMLPEmb_IndivPost', 'IndivMLPEmb_SharedIndiv' or 'IndivMLPEmb_SharedIndivPost'
max_epoch=50
lr=0.0001
wd=0.00001
lr_scheduler='cosine'
...
for dataroot_path in "${dataroots[@]}"; do
  # feat_dir=${dataroot_path}/extracted_mag${mag}_patch${patch_size}/${feat}/superpatch
