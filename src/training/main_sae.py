'''
The script is used to train sparse autoencoder for computational pathology.

TODO: remove redundant code and update to use the new training pipeline.
'''
...
def main(args):
    ...
    fold_results, fold_dumps = train(dataset_splits, args, mode='sae')
...
##
# model / loss fn args ###
parser.add_argument('--model_type', type=str, choices=['SAE'],
                    default='SAE',
                    help='type of model')
